...
navbar = dbc.NavbarSimple(
    brand='How do nine million users feel?',
    brand_href='/', 
    children=[
        ...
        dbc.Col(
            html.P(
                [
                    ...
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/<owenburton>/<repo>'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/<owenburton>/'), 
